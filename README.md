...
# GoBarber Web
Aplicativo do projeto **principal** desenvolvido durante o bootcamp GoStack da Rocketseat 🚀 para gerenciamento de agendamentos em barbearias. React Native, Typescript
